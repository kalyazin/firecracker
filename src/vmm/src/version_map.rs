...
use crate::devices::virtio::block::file::persist::BlockFileState;
...
lazy_static! {
    ...
    pub static ref VERSION_MAP: VersionMap = {
        ...
        version_map.new_version().set_type_version(BlockFileState::type_id(), 2);
        #[cfg(target_arch = "x86_64")]
        ...
        version_map.set_type_version(BlockFileState::type_id(), 3);
        ...
        version_map.set_type_version(VcpuState::type_id(), 2);
        version_map.new_version().set_type_version(DeviceStates::type_id(), 5);
