        ...
        let _: Result<(), ()> =
            self.for_each_device(|devtype, _devsubtype, devid, device_info, bus_dev| {
                ...
                match locked_device.device_type() {
                    TYPE_BALLOON => match locked_device.device_subtype() {
                        SUBTYPE_BALLOON => {
                    ...
                    TYPE_NET => match locked_device.device_subtype() {
                        SUBTYPE_NET => {
                    ...
                    TYPE_VSOCK => {
                        match locked_device.device_subtype() {
                            SUBTYPE_VSOCK => {
                    ...
                    TYPE_RNG => match locked_device.device_subtype() {
                        SUBTYPE_RNG => {
...
mod tests {
    ...
    use crate::devices::virtio::block::file::CacheType;
